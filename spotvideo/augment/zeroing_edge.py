        ...
        if self.fit_to_crop and self.shape != image.shape:
            ...
            self.warp.updateMatrixWithPoints(
                [
                    ...
                    [width * (1 - self.zeroing_ratio[3]), height * (1 - self.zeroing_ratio[1])],
                    [width * (1 - self.zeroing_ratio[3]), height * self.zeroing_ratio[0]]
                ],
                [[width * 0, height * 0], [width * 1, height * 1], [width * 1, height * 0]]
                )
